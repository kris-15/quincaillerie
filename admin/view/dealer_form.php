...
?>
<h2 class="h4 text-center card-title my-2 text-success"><?= isset($update) ? 'Modifier les informations':'Enregistrez un nouveau vendeur' ?></h2>
<?php 
    if(isset($success)){
...
<form action="" method="post">
    ...
    <button type="submit" class="btn btn-success w-100 my-2" name="<?= isset($update) ?'update_dealer':'dealer'?>"><?= isset($update) ?'Modifier':'Ajouter'?></button>
</form>